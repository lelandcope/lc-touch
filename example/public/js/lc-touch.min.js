...
lcTouch.directive('ngTapOutside', [
  '$timeout', function($timeout) {
    return function(scope, elem, attrs) {
...
lcTouch.directive('ngSwipeRight', [
  '$swipe', function($swipe) {
    return {
      restrict: 'A',
      link: function(scope, elem, attrs) {
...
lcTouch.factory('$ngDragSwipeHorizontal', [
  '$swipe', '$timeout', function($swipe, $timeout) {
    ...
    DSH = (function() {
      ...
      DSH.prototype.bind = function(scope, elem, attrs, infScroll) {
        var isHorizontalScroll, isVerticalScroll, onend, onmove, onstart, threshold, xStart, yStart,
          _this = this;
        this.elem = elem;
        this.attrs = attrs;
        this.totalChildren = this.elem.children().length;
        this.wrapperWidth = this.elem.parent().width();
        this.minDistance = attrs.ngDragSwipeHorizontalMinDistance || this.wrapperWidth * 0.5;
        this.minInertia = attrs.ngDragSwipeHorizontalMinInertia || 0.65;
...
lcTouch.directive('ngDragSwipeHorizontal', [
  '$ngDragSwipeHorizontal', function($ngDragSwipeHorizontal) {
    return {
      restrict: 'A',
      link: function(scope, elem, attrs) {
...
lcTouch.directive('lcCarouselHorizontal', [
  '$ngDragSwipeHorizontal', '$compile', '$timeout', function($ngDragSwipeHorizontal, $compile, $timeout) {
    return {
      restrict: 'A',
      link: function(scope, elem, attrs) {
        ...
        return start = function() {
          var $parent, arrowInner, autoScroll, forceArrows, infiniteScroll, lArrow, rArrow,
            _this = this;
          ...
          $timeout(function() {
            ...
            if (!(elem.children().length > 1)) {
              $parent.find('.arrow.right').css('display', 'none');
            }
            elem.animate({
              opacity: 1
            }, 300);
...
lcTouch.directive('lcCarouselItemsRendered', [
  '$timeout', function($timeout) {
    return {
      restrict: 'A',
      link: function(scope, elem, attrs) {
